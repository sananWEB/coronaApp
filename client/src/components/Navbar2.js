...
import { faHome,faBug,faUser,faMobileAlt,faMapMarker,faUserCheck,faLockOpen,faAlignRight,faInfoCircle,faBiohazard,faCropAlt } from '@fortawesome/free-solid-svg-icons'
...
<Link style={{color:'white',fontSize:"17px",textDecoration:"none"}} to="request">REQUEST</Link>
</ListItem>
{ user.login==false?null:
...
<Link style={{color:'white',fontSize:"17px",textDecoration:"none"}} to="requesttable">REQUEST CARDS</Link>
</ListItem>
      ...
      />
        ...
        <div>
          <ul className={classes.manu}>
            ...
            <li><Button component={Link} style={{color:'white',fontSize:"15px"}} to="requesttable">Blood</Button></li>
            <li><Button component={Link} style={{color:'white',fontSize:"15px"}} to="request">Request</Button></li>
