...
function Addproduct() {
  const {user,setuser}=useContext(UserContext)
    ...
    useEffect(()=>{
        axios.get("http://localhost:5000/admin/viewcatogary").then((res)=>setcatogaryName(res.data)).catch(()=>{console.log("error")})
...
formData.append('color',data1.color);
         ...
         await axios.post("http://localhost:5000/admin/addproduct",formData,{headers: {
